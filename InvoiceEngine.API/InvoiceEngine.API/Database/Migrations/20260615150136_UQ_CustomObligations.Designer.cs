...
namespace InvoiceEngine.API.Database.Migrations
{
    ...
    [Migration("20260615150136_UQ_CustomObligations")]
    partial class UQ_CustomObligations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvoiceEngine.API.Database.Entities.Article", b =>
                {
                    b.HasOne("InvoiceEngine.API.Database.Entities.Product", "Product")
                        .WithMany("Articles")
            ...
            modelBuilder.Entity("InvoiceEngine.API.Database.Entities.InvoiceItemInsuranceDetail", b =>
                {
                    b.HasOne("InvoiceEngine.API.Database.Entities.InsuranceCompany", "InsuranceCompany")
                        .WithMany("InvoiceItemInsuranceDetails")
            ...
            modelBuilder.Entity("InvoiceEngine.API.Database.Entities.InvoiceItemOrderDetail", b =>
                {
                    ...
                    b.HasOne("InvoiceEngine.API.Database.Entities.Order", "Order")
                        .WithMany("InvoiceItemOrderDetails")
            ...
            modelBuilder.Entity("InvoiceEngine.API.Database.Entities.InvoiceItemTransportDetail", b =>
                {
                    ...
                    b.HasOne("InvoiceEngine.API.Database.Entities.TransportCompany", "TransportCompany")
                        .WithMany("InvoiceItemTransportDetails")
            ...
            modelBuilder.Entity("InvoiceEngine.API.Database.Entities.OrderItem", b =>
                {
                    b.HasOne("InvoiceEngine.API.Database.Entities.Article", "Article")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("InvoiceEngine.API.Database.Entities.InsuranceCompany", b =>
                {
                    b.Navigation("InvoiceItemInsuranceDetails");
                });
            ...
            modelBuilder.Entity("InvoiceEngine.API.Database.Entities.Order", b =>
                {
                    b.Navigation("InvoiceItemOrderDetails");
            ...
            modelBuilder.Entity("InvoiceEngine.API.Database.Entities.TransportCompany", b =>
                {
                    b.Navigation("InvoiceItemTransportDetails");
                });
