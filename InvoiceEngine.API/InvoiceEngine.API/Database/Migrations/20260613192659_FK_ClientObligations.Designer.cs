...
namespace InvoiceEngine.API.Database.Migrations
{
    ...
    [Migration("20260613192659_FK_ClientObligations")]
    partial class FK_ClientObligations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvoiceEngine.API.Database.Entities.InvoiceItemObligation", b =>
                {
                    ...
                    b.HasKey("InvoiceItemId", "FromClientId", "ToClientId");
            ...
            modelBuilder.Entity("InvoiceEngine.API.Database.Entities.InvoiceItemObligation", b =>
                {
                    b.HasOne("InvoiceEngine.API.Database.Entities.Client", "FromClient")
                        .WithMany("FromClientObligations")
                        .HasForeignKey("FromClientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_InvoiceItemObligations_FromClientId");
                    ...
                    b.HasOne("InvoiceEngine.API.Database.Entities.Client", "ToClient")
                        .WithMany("ToClientObligations")
                        .HasForeignKey("ToClientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_InvoiceItemObligations_ToClientId");
            ...
            modelBuilder.Entity("InvoiceEngine.API.Database.Entities.Client", b =>
                {
                    b.Navigation("FromClientObligations");

                    b.Navigation("InvoiceClients");

                    b.Navigation("ToClientObligations");
                });
